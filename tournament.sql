...
/*
  Returns the tournament players' current standings. Caculates players' points (wins + ties * 0.5) and 
  ...
  round. The former is used for swiss-pairing purposes. The latter is used for the actual players' standings
*/
